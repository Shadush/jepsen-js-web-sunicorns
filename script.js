...
let text = " \# Snowmania \## byRomain The *goal* is to make snow fall **perpetually** so that people will always have their houses covered in snow. As they are all outside they’ll make snowfights non stop. Having nowhere to live/ warm up they will be freezing to death or die of hypothermia.";
let text2 = "\# Becode is love \## bySouSou Mass produce the becode condoms so that the world population rise up steadily. Ten or so years laters the population will more than double. The CO2 quantity in the atmosphere will explode, acidic rain and unhealthy air quality becoming the usual standard. Fifty years later the planet will ends up overusing its resources and the world would start its fall. ";
...
let text4 = "# Conquer the world  ## By Stéphanie Conquer the world by destroying large societies to take their database ! If they aren't willing, take their families hostage.";
let text5 = "# Animals! ## By Stéphanie Animals will conquer the world. They will scheme to replace humans as society leaders. And lead the world to do whatever they want with it. Humans will be the slaves of animals.";
let text6 = "# Opération Folamour ###Take control of all the nuclear warheads on the planet. After blowing up several of the world's largest cities.... It will be easier to ask for full control of the world.";
